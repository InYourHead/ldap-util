package com.inyourhead.ldap.util.api.service.auth.ldap;
...
public class LdapConfig extends Config {
    ...
    @Nullable
    @Schema(description = "Authentication strategy class. By default empty. See DirContextAuthenticationStrategy")
    private String authenticationStrategy;

    @JsonIgnore
    public Optional<String> getAuthenticationStrategyOpt() {
        return StringUtils.isNotBlank(authenticationStrategy) && !"null".equalsIgnoreCase(authenticationStrategy) ? Optional.of(authenticationStrategy) : Optional.empty();
    }
}
